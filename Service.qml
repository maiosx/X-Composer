...
// One service is mounted for the shell session while Composer.qml is the fullscreen overlay. All backend traffic and mutable composer state live here.
QtObject {
  id: root
  ...
  readonly property string backendPath: home + "/.config/omarchy/plugins/x.composer/backend.py"
